...
## Load dataset: filtered data in March 2023 only
...
## check first 5 rows of datasetd: 
...
"""
LTV/CAC ratio is less than 1 so that TechStream seems to be spending more to acquire customers than it earns from them over their lifetime. 
This could indicate an unsustainable business model.
"""